return {
	...
	config = function()
		...
		vim.list_extend(ensure_installed, {
			-- lua_ls is added to this list from `servers`, but styleua/prettierd should not be added there because they're not LSPs
		...
		-- TODO: move to separate lua files for each lsp
